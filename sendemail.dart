...
class EmailService {
  Future<void> sendemail(ctx) async {
    final useremail = FirebaseAuth.instance.currentUser!.email;
    // change password and update u r phone number
    // foodworld989@gmail.com
    // Foodworld123
    const email = "foodworld989@gmail.com";
    const pwd = "apxeekkqvpunvajw";
    final smtpServer = gmail(email, pwd);
    final msg = Message()
      ..from = const Address(email, 'Food World')
      ..recipients = ['simhadribogula@gmail.com','kanakapalli.anurag@gmail.com']
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="https://firebasestorage.googleapis.com/v0/b/foodworld-69239.appspot.com/o/restaurant%2Fimage-2.png?alt=media&token=c9e89be6-ce1d-4622-9868-7b8e04b3cfc8" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 26%;max-width: 150.8px;" width="150.8"/>
...
<table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 28px; line-height: 39.2px;"><strong><span style="line-height: 39.2px; font-size: 28px;">Your Review Added Successfully</span></strong></span></p>
  </div>
...
<table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #bbbbbb; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 12px; line-height: 16.8px;">© Food World  |  All Rights Reserved </span></p>
  </div>
...
<!--[if (mso)|(IE)]></td><![endif]-->
  ...
  <!--[if IE]></div><![endif]-->
    ...
    try {
      ...
      showSnackBar(ctx, "sent email successfully!");
